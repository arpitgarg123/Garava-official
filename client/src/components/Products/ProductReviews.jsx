          ...
          <div className="lg:col-span-4">
            <div className="bg-white p-6 sm:p-8 rounded-lg shadow-sm">
              <div className="flex flex-col items-center">
                ...
                <p className="text-[1.0625rem] text-gray-500">Based on {reviews.length} reviews</p>
                ...
                <div className="w-full mt-6 space-y-3">
                  {[5, 4, 3, 2, 1].map(rating => {
                    ...
                    return (
                      <div key={rating} className="flex  items-center text-[1.0625rem]">
                ...
                <div className="mt-8 w-full">
                  <button 
                    ...
                    className="w-full py-3 border border-black hover:bg-black hover:text-white transition-colors font-medium text-[1.0625rem] uppercase tracking-wider"
                  >
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm mt-4">
              ...
              <div className="space-y-2">
                <button 
                  ...
                  className={`w-full text-left px-3 py-2 rounded text-[1.0625rem] ${
                    sortOption === 'recent' 
                      ? 'bg-black text-white' 
                      : 'hover:bg-gray-50'
                  }`}
          ...
          <div className="lg:col-span-8">
            {showReviewForm && (
              <div className="bg-white p-6 rounded-lg shadow-sm mb-6">
                ...
                <div className="mb-4">
                  <label className="block text-[1.0625rem] font-medium text-gray-700 mb-1">Rating</label>
                  <div className="flex">
                    {[1, 2, 3, 4, 5].map(star => (
                      <button 
                        key={star} 
                ...
                <div className="mb-4">
                  <label className="block text-[1.0625rem] font-medium text-gray-700 mb-1">Title (Optional)</label>
                  <input
                    type="text"
                    value={newReview.title}
                    onChange={(e) => setNewReview({...newReview, title: e.target.value})}
                    className="w-full border-gray-300 rounded-md shadow-sm focus:ring-black focus:border-black sm:text-[1.0625rem] p-2"
                    placeholder="Summarize your experience"
                    maxLength={100}
                  />
                </div>
                <div className="mb-4">
                  <label className="block text-[1.0625rem] font-medium text-gray-700 mb-1">Review</label>
                  <textarea 
                    value={newReview.body}
                    onChange={(e) => setNewReview({...newReview, body: e.target.value})}
                    className="w-full border-gray-300 rounded-md shadow-sm focus:ring-black focus:border-black sm:text-[1.0625rem] p-2 min-h-[100px]"
                ...
                <div className="flex flex-wrap gap-2 mt-4">
                  <button 
                    ...
                    disabled={loading}
                    className="px-6 py-2.5 bg-black text-white hover:bg-gray-800 transition-colors text-[1.0625rem] uppercase tracking-wider disabled:opacity-50"
                  >
                  ...
                  <button 
                    ...
                    className="px-6 py-2.5 border border-gray-300 hover:bg-gray-50 text-[1.0625rem] uppercase tracking-wider"
                  >
                    Cancel
                  </button>
                </div>
                ...
                {reviews.map((review) => (
                  <div key={review._id} className="bg-white p-6 rounded-lg shadow-sm">
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <div className="flex items-center mt-1">
                          ...
                          <span className="ml-2 text-[1.0625rem] text-gray-500">
                      ...
                      {review.verifiedPurchase && (
                        <div className="flex items-center px-2 py-1 bg-green-50 text-green-700 rounded-full">
                          ...
                          <span className="text-[1.0625rem] font-medium">Verified Purchase</span>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="mt-4 flex items-center">
                      <span className="text-[1.0625rem] text-gray-500 mr-3">Was this helpful?</span>
                      <button 
                        onClick={() => handleVote(review._id, 'helpful')}
                        className="flex items-center text-[1.0625rem] text-gray-500 hover:text-black px-2 py-1 border rounded-md mr-2"
                      >
                      ...
                      <button 
                        ...
                        className="flex items-center text-[1.0625rem] text-gray-500 hover:text-black px-2 py-1 border rounded-md"
                      >
                    ...
                    {review.adminReply && (
                      <div className="mt-4 pl-4 border-l-2 border-gray-300">
                        <p className="text-[1.0625rem] font-medium">Response from Garava:</p>
                        <p className="text-[1.0625rem] text-gray-600 mt-1">{review.adminReply}</p>
                      </div>
                    )}
                  </div>
                ))}
                ...
                {isAuthenticated ? (
                  !showReviewForm && (
                    <button 
                      ...
                      className="mt-4 px-6 py-2 border border-black hover:bg-black hover:text-white transition-colors text-[1.0625rem] uppercase tracking-wider"
                    >
                      Write a Review
                    </button>
                  )
                ) : (
                  <p className="mt-4 text-[1.0625rem] text-gray-500">
                    Please <button 
