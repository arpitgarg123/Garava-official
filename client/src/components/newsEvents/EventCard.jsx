  ...
  return (
    <article className="group overflow-hidden bg-gray-50 mt-4">
      ...
      <div className="p-4  h-fit flex flex-col items-start justify-between">
        <div className=" flex  gap-2 text-[1.0625rem] self-start">
        ...
        <p className=" line-clamp-3 text-[1.0625rem] text-muted-foreground self-start" >{item.excerpt}</p>

        <div className="mt-4 flex  gap-3 self-start">
          {item.rsvpUrl && (
            <a
              href={item.rsvpUrl}
              className="inline-flex  rounded-xl bg-primary px-3 py-2 text-[1.0625rem] font-medium text-primary-foreground"
            >
              RSVP
            </a>
          )}
          <a
            ...
            className="text-[1.0625rem] font-medium underline underline-offset-4 hover:opacity-80"
          >
            View details
          </a>
        </div>
