...
//           {testimonial.name}
//         </h4>
//         <p className="text-gray-500 text-sm sm:text-sm font-medium">
    ...
    <div className="w-full py-12 sm:py-16 lg:py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 lg:mb-16">
          <div className="h-8 sm:h-10 lg:h-12 bg-gray-200 rounded-lg w-80 mx-auto mb-4 animate-pulse"></div>
          <div className="h-5 bg-gray-200 rounded-lg w-96 mx-auto animate-pulse"></div>
        </div>
