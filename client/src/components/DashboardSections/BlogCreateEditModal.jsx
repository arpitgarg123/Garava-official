          ...
          {(isEditMode && !currentBlog && actionLoading) ? (
            ...
            {error && (
              <div className="mb-4 bg-red-50 border border-red-200 rounded-md p-3">
                <div className="text-red-800 text-[1.0625rem]">
                  {error}
                </div>
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div className="sm:col-span-2">
                  ...
                  {validationErrors.title && (
                    <p className="mt-1 text-[1.0625rem] text-red-600">{validationErrors.title}</p>
                  )}
                </div>

                {/* Slug */}
                <div className="sm:col-span-2">
                  <label htmlFor="slug" className="block text-[1.0625rem] font-medium text-gray-700">
                    Slug *
                  </label>
                  <input
                    type="text"
                  ...
                  {validationErrors.slug && (
                    <p className="mt-1 text-[1.0625rem] text-red-600">{validationErrors.slug}</p>
                  )}
                </div>

                {/* Category */}
                <div>
                  <label htmlFor="category" className="block text-[1.0625rem] font-medium text-gray-700">
                    Category *
                  </label>
                  <select
                    name="category"
                  ...
                  {validationErrors.category && (
                    <p className="mt-1 text-[1.0625rem] text-red-600">{validationErrors.category}</p>
                  )}
                </div>

                {/* Status */}
                <div>
                  <label htmlFor="status" className="block text-[1.0625rem] font-medium text-gray-700">
                    Status
                  </label>
                  <select
                    name="status"
                ...
                {formData.status === 'scheduled' && (
                  <div className="sm:col-span-2">
                    <label htmlFor="publishAt" className="block text-[1.0625rem] font-medium text-gray-700">
                      Publish Date *
                    </label>
                    <input
                      type="datetime-local"
                    ...
                    {validationErrors.publishAt && (
                      <p className="mt-1 text-[1.0625rem] text-red-600">{validationErrors.publishAt}</p>
                    )}
                  </div>
                )}
                ...
                {/* Tags */}
                <div className="sm:col-span-2">
                  <label htmlFor="tags" className="block text-[1.0625rem] font-medium text-gray-700">
                    Tags
                  </label>
                  <input
                    type="text"
                  ...
                  />
                  <p className="mt-1 text-[1.0625rem] text-gray-500">Separate tags with commas</p>
                </div>

                {/* Excerpt */}
                <div className="sm:col-span-2">
                  <label htmlFor="excerpt" className="block text-[1.0625rem] font-medium text-gray-700">
                    Excerpt
                  </label>
                  <textarea
                    name="excerpt"
              ...
              {/* Cover Image */}
              <div>
                <label htmlFor="coverImage" className="block text-[1.0625rem] font-medium text-gray-700">
                  Cover Image
                </label>
                <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                  <div className="space-y-1 text-center">
                    ...
                    <div className="flex text-[1.0625rem] text-gray-600">
                      <label
                        htmlFor="coverImage"
                    ...
                    <p className="text-[1.0625rem] text-gray-500">PNG, webp, GIF up to 10MB</p>
                  </div>
                </div>
              </div>
  ...
  />
              ...
              <div className="border-t pt-6">
                ...
                <div className="space-y-4">
                  <div>
                    <label htmlFor="metaTitle" className="block text-[1.0625rem] font-medium text-gray-700">
                      Meta Title
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="metaDescription" className="block text-[1.0625rem] font-medium text-gray-700">
                      Meta Description
                    </label>
                    <textarea
              ...
              <div className="flex items-center justify-end space-x-3 pt-6 border-t">
                <button
                  type="button"
                  onClick={handleClose}
                  className="px-4 py-2 border border-gray-300 rounded-md text-[1.0625rem] font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="px-4 py-2 border border-transparent rounded-md shadow-sm text-[1.0625rem] font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {actionLoading ? (
                    <div className="flex items-center">
