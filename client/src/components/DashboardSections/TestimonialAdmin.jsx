        ...
        <div className="bg-white  p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={handleSubmit}>
              <div className="space-y-4">
                <div>
                  <label className="block text-[1.0625rem] font-medium mb-1">Name *</label>
                  <input
                    type="text"
                    value={formData.name}
                ...
                <div>
                  <label className="block text-[1.0625rem] font-medium mb-1">Email</label>
                  <input
                    type="email"
                ...
                <div>
                  <label className="block text-[1.0625rem] font-medium mb-1">Content *</label>
                  <textarea
                ...
                <div>
                  <label className="block text-[1.0625rem] font-medium mb-1">Rating</label>
                  <select
                ...
                <div>
                  <label className="block text-[1.0625rem] font-medium mb-1">Location</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-[1.0625rem] font-medium mb-1">Designation</label>
                  <input
                    type="text"
      ...
      <div className="border-b border-gray-200 mb-6">
        <nav className="flex space-x-8">
          <button
            ...
            className={`py-2 px-1 border-b-2 font-medium text-[1.0625rem] ${
              activeTab === 'list'
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {testimonials && testimonials.length > 0 ? testimonials.map((testimonial) => (
                    <tr key={testimonial._id}>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div>
                          ...
                          {testimonial.location && (
                            <div className="text-[1.0625rem] text-gray-500">{testimonial.location}</div>
                          )}
                        </div>
                      </td>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-[1.0625rem] font-medium ${
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center space-x-2">
                          ...
                          {testimonial.isFeatured && (
                            <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-[1.0625rem] font-medium bg-yellow-100 text-yellow-800">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-[1.0625rem] font-medium">
                        <div className="flex items-center space-x-2">
                          <button
                    ...
                    <tr>
                      <td colSpan="6" className="px-6 py-12 text-center">
                        <div className="text-gray-500">
                          ...
                          <h3 className="mt-2 text-[1.0625rem] font-medium text-gray-900">No testimonials found</h3>
                          <p className="mt-1 text-[1.0625rem] text-gray-500">
                          ...
                          {!filters.search && !filters.source && !filters.isActive && !filters.isFeatured && (
                            <div className="mt-6">
                              <button
                                onClick={() => openModal('create')}
                                className="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-[1.0625rem] font-medium  text-white bg-blue-600 hover:bg-blue-700"
                              >
            ...
            <>
              ...
              <div className="bg-white p-6  shadow">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-[1.0625rem] font-medium text-gray-600">Active</p>
              ...
              <div className="bg-white p-6  shadow">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-[1.0625rem] font-medium text-gray-600">Featured</p>
                    <p className="text-3xl font-semibold text-gray-900">{stats.featured}</p>
                  </div>
                </div>
              </div>
              <div className="bg-white p-6  shadow">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-[1.0625rem] font-medium text-gray-600">Google</p>
                    <p className="text-3xl font-semibold text-gray-900">{stats.google}</p>
                  </div>
                </div>
              </div>
            </>
