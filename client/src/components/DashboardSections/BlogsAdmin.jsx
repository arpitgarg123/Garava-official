...
//             <p className="text-[1.0625rem] text-gray-600">Create and manage blog posts</p>
//           </div>
//           <button 
...
//               <p className="text-gray-400 text-[1.0625rem] mt-1">Create your first blog post to get started</p>
//             </div>
//           </div>
//         ) : (
...
//                             {blog.title}
//                           </div>
//                           <div className="text-[1.0625rem] text-gray-500 max-w-xs truncate">
//                             {blog.description}
//                           </div>
//                         </div>
//                       </div>
...
//                     </td>
//                     <td className="px-6 py-4 whitespace-nowrap">
//                       <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-[1.0625rem] font-medium ${getStatusColor(blog.status)}`}>
//                         {blog.status}
//                       </span>
//                     </td>
//                     <td className="px-6 py-4 whitespace-nowrap">
//                       <div className="flex items-center text-[1.0625rem] text-gray-900">
      ...
      <div className="flex p-4">
        ...
        <div className="flex-1 ml-4">
          <div className="flex items-start justify-between mb-2">
            ...
            <span className={`ml-2 inline-flex items-center px-2 py-1 rounded-full text-[1.0625rem] font-medium flex-shrink-0 ${getStatusColor(blog.status)}`}>
              {blog.status}
            </span>
          </div>
          
          <p className="text-[1.0625rem] sm:text-[1.0625rem] text-gray-600 line-clamp-2 mb-2">
            {blog.description}
          </p>
