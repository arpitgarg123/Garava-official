        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center gap-3">
              <span className={`inline-flex items-center px-3 py-1 rounded-full text-[1.0625rem] font-medium border ${getAppointmentStatusColor(appointment.status)}`}>
          ...
          <div className="mb-6">
            <label htmlFor="status" className="block text-[1.0625rem] font-medium text-gray-700 mb-2">
              New Status *
            </label>
            <select
              id="status"
            ...
            {selectedStatusInfo && selectedStatus !== appointment.status && (
              <div className="mt-2 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <div className="flex items-center gap-2 mb-1">
                  <span className={`inline-flex items-center px-2 py-1 rounded-full text-[1.0625rem] font-medium border ${getAppointmentStatusColor(selectedStatus)}`}>
                    {selectedStatusInfo.label}
                  </span>
                </div>
                <p className="text-[1.0625rem] text-blue-700">{selectedStatusInfo.description}</p>
              </div>
            )}
          </div>
          ...
          {selectedStatus === 'confirmed' && (
            <div className="mb-6">
              <div className="flex items-center gap-2 mb-3">
                ...
                />
                <label htmlFor="reschedule" className="text-[1.0625rem] font-medium text-gray-700">
              ...
              {isRescheduling && (
                <div className="pl-6 border-l-2 border-blue-200 space-y-4">
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label htmlFor="rescheduleDate" className="block text-[1.0625rem] font-medium text-gray-700 mb-1">
                        New Date
                      </label>
                      <input
                        type="date"
                    ...
                    <div>
                      <label htmlFor="rescheduleTime" className="block text-[1.0625rem] font-medium text-gray-700 mb-1">
                        New Time
                      </label>
                      <input
                        type="time"
                  ...
                  {rescheduleDate && rescheduleTime && (
                    <div className="text-[1.0625rem] text-blue-600 bg-blue-50 p-2 rounded">
          ...
          {/* Admin Notes */}
          <div className="mb-6">
            <label htmlFor="adminNotes" className="block text-[1.0625rem] font-medium text-gray-700 mb-2">
              Admin Notes
            </label>
            <textarea
              id="adminNotes"
          ...
          {appointment.notes && (
            <div className="mb-6">
              ...
              <div className="p-3 bg-gray-50 border border-gray-200 rounded-lg">
                <p className="text-[1.0625rem] text-gray-700">{appointment.notes}</p>
              </div>
            </div>
          )}
          ...
          {selectedStatus === 'cancelled' && (
            <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg">
              ...
              <p className="text-[1.0625rem] text-red-700">
          ...
          {selectedStatus === 'confirmed' && !isRescheduling && (
            <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
              ...
              <p className="text-[1.0625rem] text-blue-700">
          ...
          {selectedStatus === 'confirmed' && isRescheduling && (
            <div className="mb-6 p-4 bg-orange-50 border border-orange-200 rounded-lg">
              ...
              <p className="text-[1.0625rem] text-orange-700">
