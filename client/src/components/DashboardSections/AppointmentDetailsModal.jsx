      ...
      <div className="relative top-20 mx-auto p-5 border w-11/12 max-w-3xl shadow-lg rounded-md bg-white">
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-[1.0625rem] text-gray-500 mt-1">ID: {appointment._id}</p>
          </div>
          <button
            onClick={onClose}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <div className="space-y-3">
                ...
                <div className={`text-[1.0625rem] font-medium ${urgency.color}`}>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <div className="text-[1.0625rem] text-gray-500">Full Name</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <div className="text-[1.0625rem] text-gray-500">Email Address</div>
                    </div>
                  </div>
                </div>
                  ...
                  {formattedAppointment.customerPhone && (
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <div className="text-[1.0625rem] text-gray-500">Phone Number</div>
                      </div>
                    </div>
                  )}
                  ...
                  {appointment.user && (
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <div className="text-[1.0625rem] text-gray-500">Account Holder</div>
                      </div>
                    </div>
                  )}
                  ...
                  {!appointment.user && (
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <div className="text-[1.0625rem] text-gray-500">No account</div>
                      </div>
                    </div>
                  )}
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-[1.0625rem] text-gray-500">Date</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-[1.0625rem] text-gray-500">Time</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-[1.0625rem] text-gray-500">Status</div>
                  </div>
                </div>
              </div>
            </div>
