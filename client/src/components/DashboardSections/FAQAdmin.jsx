        ...
        <div className="flex-shrink-0 p-4 sm:p-6 border-t border-gray-200 bg-white">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="hidden sm:flex items-center gap-2">
              ...
              <span className="px-3 py-1 bg-blue-600 text-white rounded text-md">
                {currentPage}
              </span>
              <button
                onClick={() => setCurrentPage(prev => Math.min(prev + 1, list.totalPages))}
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4">
      <div className="bg-white rounded-lg w-full max-w-2xl max-h-[95vh] sm:max-h-[90vh] overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-4 max-h-[calc(95vh-80px)] sm:max-h-[calc(90vh-120px)] overflow-y-auto">
          <div>
            <label className="block text-md font-medium mb-2">Question *</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-md font-medium mb-2">Answer *</label>
            <textarea
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-md font-medium mb-2">Priority (0-10)</label>
              <input
                type="number"
                min="0"
                max="10"
          ...
          <div>
            <label className="block text-md font-medium mb-2">Keywords (comma-separated)</label>
            <input
              type="text"
        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-4 max-h-[calc(95vh-80px)] sm:max-h-[calc(90vh-120px)] overflow-y-auto">
          ...
          <div className="flex items-center">
            <input
              ...
              className="mr-2"
            />
            <label htmlFor="isActive" className="text-md font-medium">Active</label>
          </div>
    ...
    <div className="p-4 sm:p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-md font-medium mb-2">Select CSV File</label>
            <input
              type="file"
              accept=".csv"
              onChange={handleFileChange}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg outline-none text-md"
            />
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors text-md"
            >
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-md"
            >
