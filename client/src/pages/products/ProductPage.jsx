...
const ProductPage = () => {
  ...
  const getCategoryBanner = () => {
    ...
    const banners = {
      'jewellery': {
        ...
        // description: 'Discover our exquisite range of fine jewellery, from classic designs to contemporary masterpieces',
        image: jBanner,
        // gradient: 'from-amber-900 via-amber-800 to-yellow-700'
      },
      'high-jewellery': {
        // title: 'High Jewellery',
        // subtitle: 'Exceptional artistry meets precious materials',
        // description: 'Explore our most prestigious collection featuring rare gemstones and unparalleled craftsmanship',
        image: jBanner,
        // gradient: 'from-purple-900 via-indigo-800 to-blue-900'
      },
      'fragrance': {
        // title: 'Fragrance Collection',
        // subtitle: 'Capture memories in every scent',
        // description: 'Immerse yourself in our carefully curated selection of luxury fragrances and signature scents',
        image: fBanner,
      ...
      'all': {
        ...
        // description: 'Browse our entire range of premium jewellery and fragrances, each piece a testament to excellence',
        image: jBanner,
  ...
  return (
    <div className="w-full mt-20 max-md:mt-0 relative">
      <section className="relative h-[45vh] mt-30 lg:h-[64vh] overflow-hidden">
      ...
      <div className="w-full py-6">
        <div className="w-full max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-0">
          ...
          <div className="md:hidden mb-4 flex justify-end items-center">
            <button 
              onClick={() => setShowMobileFilters(true)}
              className="flex items-center gap-2 px-4 py-2 border rounded-md bg-white shadow-sm"
            >
              <BiFilterAlt />
              <span>Filters</span>
            </button>
