...
const ProfilePage = () => {
    ...
    return (
     <div className="min-h-screen  py-8 mt-2">
       ...
       <div className="space-y-4">
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-white  shadow-sm p-6 animate-pulse">
  ...
  const renderContent = () => {
    switch (activeTab) {
      case "profile":
        return (
          <div className="bg-white   shadow-sm border border-gray-300 p-4 sm:p-6">
          ...
          <div className=" p-4 sm:p-6">
            ...
            {isOrdersLoading ? (
              <div className="text-center py-12">
                <div className="animate-spin-full h-8 w-8 border-b-1 border-gray-100 mx-auto"></div>
                <p className="mt-4 text-gray-500">Loading orders...</p>
              </div>
            ) : userOrders && userOrders.length > 0 ? (
              <div className="space-y-4">
                {userOrders.map((order) => (
                  <div key={order._id} className="border border-gray-300  p-4 hover:shadow-sm transition-shadow">
      ...
      case "addresses":
        return (
          <div className="bg-white  shadow-sm border p-4 sm:p-6">
            <AddressSelector 
        ...
        <div className="lg:grid lg:grid-cols-4 lg:gap-8">
          ...
          <div className="lg:hidden mb-4">
            <button
              ...
              className="w-full bg-white border border-gray-300  p-4 flex items-center justify-between "
            >
          ...
          <div className={`lg:col-span-1 ${sidebarOpen ? 'block' : 'hidden lg:block'} mb-4 lg:mb-0`}>
            <div className="bg-white   border border-gray-300 p-4 sm:p-6 lg:sticky lg:top-24">
              {/* User Info */}
