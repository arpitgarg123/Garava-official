              ...
              {event.rsvpUrl && (
                <div className="mt-6">
                  <a 
                    ...
                    className="inline-flex items-center rounded-xl bg-primary px-4 py-2 text-md font-medium text-primary-foreground hover:opacity-90"
                  >
                    RSVP ↗
                  </a>
                </div>
      ...
      <section className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
          ...
          <article className="lg:col-span-8">
            ...
            <div className="py-8">
              <h3 className="mb-3 text-md font-semibold">Share this event</h3>
          ...
          {/* <aside className="lg:col-span-4 space-y-6">
            {event.ctaNote && (
              <div className="rounded-2xl border bg-card p-5 shadow-sm">
                <h3 className="text-md font-semibold">Good to know</h3>
                <p className="mt-2 text-md text-muted-foreground">{event.ctaNote}</p>
              </div>
            )} */}
