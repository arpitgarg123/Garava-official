              ...
              <section className="border-b border-gray-100 pb-8">
                ...
                <div className="prose max-w-none text-gray-700">
                  ...
                  <div className="bg-amber-50 border border-amber-200 rounded-lg p-6 mb-6">
                    ...
                    <ul className="list-disc list-inside space-y-2 text-md text-amber-800">
              ...
              <section className="border-b border-gray-100 pb-8">
                ...
                <div className="prose max-w-none text-gray-700">
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                    ...
                    <ul className="list-disc list-inside space-y-2 text-md text-blue-800">
              ...
              <section className="border-b border-gray-100 pb-8">
                ...
                <div className="prose max-w-none text-gray-700">
                  ...
                  <div className="bg-green-50 border border-green-200 rounded-lg p-6">
                    ...
                    <ul className="list-disc list-inside space-y-2 text-md text-green-800">
