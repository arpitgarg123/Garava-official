...
const Wishlist = () => {
  ...
  return (
  <div className=" min-h-[60vh] mt-34 max-md:mt-0 ">
 <div className="sticky top-58 z-10 mb-3 max-md:top-7 max-sm:top-0s">
        <BackButton />
      </div>
                ...
                <div key={productId || `wishlist-item-${index}`} className="p-4 space-y-3">
                  ...
                  <div className="flex justify-between items-center pt-2">
                    <button
                      ...
                      className={`px-4 py-2 text-[1.0625rem] transition cursor-pointer ${
                        isOutOfStock 
